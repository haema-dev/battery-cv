# -*- coding: utf-8 -*-
"""
Battery Defect Classification V5 - 4-class with Normal + Focal Loss
- 4 classes: Damaged / Pollution / Damaged+Pollution / Normal
- Focal Loss for better handling of hard examples
- EfficientNet-B0 (proven best at V3)
...
class DefectClassifier(pl.LightningModule):
    def __init__(self, num_classes=NUM_CLASSES, lr=5e-4,
                 ...
                 focal_gamma=2.0, scheduler_type="cosine"):
        super().__init__()
...
# ============================================================
def main():
    parser = argparse.ArgumentParser(description="Battery Defect Classification V5 (4-class)")
    ...
    logger.info("=" * 60)
    logger.info("Battery Defect Classification V5 (4-class)")
    ...
    if is_main_process:
        try:
            ...
            mlflow.log_params({
                ...
                "focal_gamma": args.focal_gamma, "scheduler": args.scheduler,
