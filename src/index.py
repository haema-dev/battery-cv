...
def main():
    ...
    logger.info(f"⚙️ 설정: Backbone={args.backbone}, Epochs={args.epochs}, Seed={args.seed}")
    logger.info("==================================================")

    # ... (생략된 기존 경로 검증 및 디버깅 로그 부분은 유지) ...
    ...
    try:
        ...
        logger.warning(f"⚠️ 구조 출력 중 오류 (무시 가능): {e}")
    ...
    try:
        ...
        # 최적 임계값 로깅 (사용자가 나중에 수동으로 참고할 수 있도록)
